...
class user:
    ...
    #Draw Widgets
    def widgets(self):
        self.head = Label(self.master, text='Login Details Page', font=('', 30), pady=10)
        self.head.pack()
        ...
        Button(self.logf,text = ' Register' ,font = ('',15),padx=5,pady=5,command=self.cr).grid(row=2,column=1)
        self.logf.pack()
...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def iExit():
            iExit= ms.askyesno("Prompt!","Do you want to exit now?")
            if iExit > 0:
                root.destroy()
                return
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Edinburgh":
                    switch ={"Roman-Era Bath": 10,"Wonderful Windsor": 8,"The Cotswolds and Lake District":6,"Edinburgh": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Roman-Era Bath":
                    switch ={"BrownAvenue": 0,"Wonderful Windsor": 2,"The Cotswolds and Lake District":5,"Edinburgh": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Wonderful Windsor":
                    switch ={"Roman-Era Bath": 2,"Wonderful Windsor": 0,"The Cotswolds and Lake District":3,"Edinburgh": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "The Cotswolds and Lake District":
                    switch ={"Roman-Era Bath": 5,"Wonderful Windsor": 3,"The Cotswolds and Lake District":0,"Edinburgh": 6}
                    Km.set(switch[varl2.get()])
        ...
        def Total_Paid():
            if ((var1.get() == 1 and var2.get() == 1 and var3.get() == 1 or var4.get() == 1) and carType.get() != 0 and journeyType.get() != 0 and (varl1.get() != "" and varl2.get() !="")):
                ...
                w = ms.showwarning("Error !","Wrong Input\nPlease try again !!!")
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('Times New Roman',50,'bold'),text="\t  Car Booking system")
        self.lblTitle.grid()
    ...
    #================================================customerframedetail=============================================================
        ...
        CustomerName=LabelFrame(FrameDetails, width=150,height=250,bd=10, font=('Times New Roman',12,'bold'),text="Customer Details", relief=RIDGE)
        CustomerName.grid(row=0,column=0)

        TravelFrame = LabelFrame(FrameDetails,bd=10, width=300,height=250, font=('Times New Roman',12,'bold'),text="Booking Info", relief=RIDGE)
    ...
    #=========================================================CustomerName====================================================
        ...
        self.txtFirstname=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Firstname,bd=7,insertwidth=2,justify=RIGHT)
        ...
        self.txtSurname=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Surname,bd=7,insertwidth=2,justify=RIGHT)
        ...
        self.txtAddress=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Address,bd=7,insertwidth=2,justify=RIGHT)
        self.txtAddress.grid(row=2,column=1)


        self.lblPostcode=Label(CustomerName,font=('Times New Roman',14,'bold'),text="Postcode",bd=7)
        self.lblPostcode.grid(row=3,column=0,sticky=W)
        self.txtPostcode=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Postcode,bd=7,insertwidth=2,justify=RIGHT)
        ...
        self.txtTelephone=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Telephone,bd=7,insertwidth=2,justify=RIGHT)
        ...
        self.txtMobile=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Mobile,bd=7,insertwidth=2,justify=RIGHT)
        self.txtMobile.grid(row=5,column=1)

        self.lblEmail=Label(CustomerName,font=('Times New Roman',14,'bold'),text="Email",bd=7)
        self.lblEmail.grid(row=6,column=0,sticky=W)
        self.txtEmail=Entry(CustomerName,font=('Times New Roman',14,'bold'),textvariable=Email,bd=7,insertwidth=2,justify=RIGHT)
        self.txtEmail.grid(row=6,column=1)

 
    #===============================================Cab Information==============================================================
        self.lblPickup = Label(TravelFrame, font=('arial', 14, 'bold'), text="Pickup Location", bd=7)
        self.lblPickup.grid(row=0,column=0,sticky=W)

        self.cboPickup =ttk.Combobox(TravelFrame, textvariable = varl1 , state='readonly', font=('Times New Roman',20,'bold'), width=14)
        self.cboPickup['value']=('','Roman-Era Bath"','Wonderful Windsor','The Cotswolds and Lake District','Edinburgh')
        self.cboPickup.current(0)
        self.cboPickup.grid(row=0,column=1)

        self.lblDrop = Label(TravelFrame, font=('arial', 14, 'bold'), text="Drop Location", bd=7)
        self.lblDrop.grid(row=1,column=0,sticky=W)

        self.cboDrop =ttk.Combobox(TravelFrame, textvariable = varl2 , state='readonly', font=('Times New Roman',20,'bold'), width=14)
        self.cboDrop['value']=('','Beaconsfield','East Cambridgeshire ','Ampthill ','Northwich')
        self.cboDrop.current(0)
        ...
        self.cboPooling =ttk.Combobox(TravelFrame, textvariable = varl3 , state='readonly', font=('Times New Roman',20,'bold'), width=14)
    ...
    #===============================================Cab Information==============================================================
        ...
        self.chkCabTax=Checkbutton(TravelFrame,text="Base Charge *",variable = var1, onvalue=1, offvalue=0,font=('Times New Roman',16,'bold'),command=Cab_Tax).grid(row=3, column=0, sticky=W)
        self.txtCabTax=Label(TravelFrame,font=('Times New Roman',14,'bold'),textvariable=CabTax,bd=6,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN)
        self.txtCabTax.grid(row=3,column=1)


        self.chkKm=Checkbutton(TravelFrame,text="Distance(KMS) *",variable = var2, onvalue=1, offvalue=0,font=('Times New Roman',16,'bold'),command=Kilo).grid(row=4, column=0, sticky=W)
        self.txtKm=Label(TravelFrame,font=('Times New Roman',14,'bold'),textvariable=Km,bd=6,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN,highlightthickness=0)
        self.txtKm.grid(row=4,column=1)

        self.chkTravel_Ins=Checkbutton(TravelFrame,text="Travelling Insurance *",variable = var3, onvalue=1, offvalue=0,font=('Times New Roman',16,'bold'),command=Travelling).grid(row=5, column=0, sticky=W)
        self.txtTravel_Ins=Label(TravelFrame,font=('Times New Roman',14,'bold'),textvariable=Travel_Ins,bd=6,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN)
        self.txtTravel_Ins.grid(row=5,column=1)

      
        self.chkLuggage=Checkbutton(TravelFrame,text="Luggage Details",variable = var4, onvalue=1, offvalue=0,font=('Times New Roman',16,'bold'),command=Lug).grid(row=6, column=0, sticky=W)
        self.txtLuggage=Label(TravelFrame,font=('Times New Roman',14,'bold'),textvariable=Luggage,bd=6,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN)
    ...
    #=================================payment information ===========================================================================
        ...
        self.txtPaidTax = Label(CostFrame,font=('Times New Roman',14,'bold'),textvariable=PaidTax,bd=7, width=10, justify=RIGHT,bg="white",relief=SUNKEN)
        ...
        self.txtSubTotal = Label(CostFrame,font=('Times New Roman',14,'bold'),textvariable=SubTotal,bd=7, width=10, justify=RIGHT,bg="white",relief=SUNKEN)
        ...
        self.txtTotalCost = Label(CostFrame,font=('Times New Roman',14,'bold'),textvariable=TotalCost,bd=7, width=10, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtTotalCost.grid(row=2,column=3)

    #==========================================================Cabselect=======================================================================

        self.chkStandard=Radiobutton(Book_Frame,text="Coach",value=1,variable = carType,font=('Times New Roman',14,'bold'),command=selectCar).grid(row=0, column=0, sticky=W)
        self.txtStandard = Label(Book_Frame,font=('Times New Roman',14,'bold'),width =7,textvariable=Standard,bd=5, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtStandard.grid(row=0,column=1)
        

        self.chkFordGalaxyd=Radiobutton(Book_Frame,text="Mini Bus",value=2,variable = carType,font=('Times New Roman',14,'bold'),command=selectCar).grid(row=1, column=0, sticky=W)
        self.txtFordGalaxy= Label(Book_Frame,font=('Times New Roman',14,'bold'),width =7,textvariable=FordGalaxy,bd=5, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtFordGalaxy.grid(row=1,column=1)
             
       
        self.chkFordMondeo = Radiobutton(Book_Frame,text="Private car",value=3,variable = carType,font=('Times New Roman',14,'bold'),command=selectCar).grid(row=2, column=0)
        self.txtFordMondeo = Label(Book_Frame,font=('Times New Roman',14,'bold'),width =7,textvariable=FordMondeo,bd=5, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtFordMondeo.grid(row=2,column=1)

        self.chkSingle =Radiobutton(Book_Frame,text="Single",value=1,variable = journeyType,font=('Times New Roman',14,'bold')).grid(row=0, column=2, sticky=W)
        self.chkReturn =Radiobutton(Book_Frame,text="Return",value=2,variable = journeyType,font=('Times New Roman',14,'bold')).grid(row=1, column=2, sticky=W)
        self.chkSpecialsNeeds =Radiobutton(Book_Frame,text="SpecialNeeds",value=3,variable = journeyType,font=('Times New Roman',14,'bold')).grid(row=2, column=2, sticky=W)
    ...
    #======================================Button========================================================================================
        ...
        self.btnTotal = Button(ButtonFrame,padx=18,bd=7,font=('Times New Roman',11,'bold'),width = 2,text='Total',command=Total_Paid).grid(row=0,column=0)
        self.btnReceipt = Button(ButtonFrame,padx=18,bd=7,font=('Times New Roman',11,'bold'),width = 2,text='Receipt',command=Receiptt).grid(row=0,column=1)
        self.btnReset = Button(ButtonFrame,padx=18,bd=7,font=('Times New Roman',11,'bold'),width = 2,text='Reset',command=Reset).grid(row=0,column=2)
        self.btnExit = Button(ButtonFrame,padx=18,bd=7,font=('Times New Roman',11,'bold'),width = 2,text='Exit', command=iExit).grid(row=0,column=3)
...
if __name__=='__main__':
    ...
    root.title('Login Form for Solent Excursions')
    Image_0 = Image.open('D:\\moumita sarkar\\february\\28-2-2022\\gettyimages-499835752-612x612.jpg')
